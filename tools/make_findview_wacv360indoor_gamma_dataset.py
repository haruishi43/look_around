...
from LookAround.FindView.dataset.wacv360indoor.helpers.gamma import (
    gather_image_paths,
    create_splits,
...
if __name__ == "__main__":
    ...
    dataset_root = os.path.join(
        cfg.dataset_root, cfg.dataset.name, cfg.dataset.version
    )
    ...
    for name, paths in splits.items():
        ...
        for path in tqdm(paths):
            assert os.path.exists(
                os.path.join(wacv360_root, path)
