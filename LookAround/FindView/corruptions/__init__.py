...
"""Code borrowed from `imagecorruptions`
https://github.com/bethgelab/imagecorruptions

Evgenia Rusak, Benjamin Mitzkus
evgenia.rusak@bethgelab.org, benjamin.mitzkus@bethgelab.org
"""
...
# og_corruption_dict = {
#     corr_func.__name__: corr_func for corr_func in og_corruption_tuple
# }
...
# def og_corrupt(image, severity=1, corruption_name=None, corruption_number=-1):
...
#         image_corrupted = og_corruption_dict[corruption_name](
#             Image.fromarray(image),
#             severity,
#         )
#     elif corruption_number != -1:
#         image_corrupted = og_corruption_tuple[corruption_number](
#             Image.fromarray(image),
#             severity,
#         )
#     else:
...
def corrupt(image, severity=1, corruption_name=None, corruption_number=-1):
    ...
    Args:
        ...
        corruption_name (str):      specifies which corruption function to call, must be one of
                                        'gaussian_noise', 'shot_noise', 'impulse_noise', 'defocus_blur',
                                        'glass_blur', 'motion_blur', 'snow', 'frost', 'fog',
                                        'brightness', 'contrast', 'jpeg_compression', 'speckle_noise',
...
# def og_get_corruption_names(subset='common'):
#     if subset == 'common':
#         return [f.__name__ for f in og_corruption_tuple[:15]]
#     elif subset == 'validation':
#         return [f.__name__ for f in og_corruption_tuple[15:]]
#     elif subset == 'all':
#         return [f.__name__ for f in og_corruption_tuple]
#     elif subset == 'noise':
#         return [f.__name__ for f in og_corruption_tuple[0:3]]
#     elif subset == 'blur':
#         return [f.__name__ for f in og_corruption_tuple[3:7]]
#     elif subset == 'weather':
#         return [f.__name__ for f in og_corruption_tuple[7:11]]
#     elif subset == 'digital':
#         return [f.__name__ for f in og_corruption_tuple[11:15]]
#     else:
