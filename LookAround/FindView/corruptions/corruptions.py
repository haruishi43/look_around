...
"""
TODO:
- random state is global
  - has no effect for benchmarks
  - has effect on multithreaded/multiprocessing training
"""
...
def frost(x, severity=1):
    ...
    # FIXME: change this so that it won't matter where the code is ran
    # root = './LookAround/FindViewCorrupted/corruptions'
