...
__all__ = [
    ...
    "BasicCorruptedFindviewRLEnv",
]


class CorruptedFindViewRLEnv(gym.Env):

    # Hidden Properties
    _env: CorruptedFindViewEnv
    ...
    def __init__(
        ...
        self._env = CorruptedFindViewEnv.from_config(
            cfg=cfg,
            split=split,
            filter_fn=filter_fn,
    ...
    @property
    def env(self) -> CorruptedFindViewEnv:
        return self._env
    ...
    def change_severity(self, severity: int) -> None:
        self._env.change_severity(severity=severity)
